    ...
    <div className="min-h-screen mb-20 bg-app-cream">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 ">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <span
            className={`px-4 py-1.5 text-sm font-semibold rounded-xl ${order.status === "Delivered" ? "bg-green-100 text-green-700 " : order.status === "Cancelled" ? "ng-red-100 text-red-700" : "bg-app-orange/10 text-app-orange"}`}
          >
            {order.status}
          </span>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
              ...
              order.status !== "Cancelled" && (
                <div className="bg-white rounded-2xl p-5 flex items-center justify-between">
                  ...
                  <a
                    ...
                    className="p-2.5 bg-app-cream hover:bg-app-cream-dark rounded-xl transition-colors"
                  >
          ...
          <div className="space-y-5">
            ...
            <div className="bg-white rounded-2xl p-5">
              <h3 className="text-sm text-app-green font-semibold mb-3 flex items-center gap-2">
            ...
            {/* Item */}
            <div className="bg-white rounded-2xl p-5">
              <h3 className="text-sm text-app-green mb-3 font-semibold">
                ...
                {order?.items.map((item, i) => (
                  <div key={i} className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-medium text-green truncate">
                        {item.name}
                      </p>
