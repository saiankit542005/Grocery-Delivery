        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <p className="text-sm text-app-text-light mb-6 max-w-md mx-auto">
              We countn't find any products matching "{query}".Try a different
              search term.
            </p>
            <Link
              to="/products"
              className="inline-flex px-5 py-2.5 bg-app-green text-white text-sm rounded-lg font-semibold"
            >
              Browse All Products
            </Link>
          </div>
