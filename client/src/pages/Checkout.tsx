...
const Checkout = () => {
  ...
  const deliveryFee = cartTotal > 400 ? 0 : 25;
      ...
      <div className="min-h-screen bg-app-cream flex-center">
        <div className="text-center">
          ...
          <button
            ...
            className="px-5 py-2.5 text-sm text-white bg-app-green font-semibold rounded-xl hover:bg-app-green-light transition-colors"
          >
            Browse Products
          </button>
        </div>
          ...
          <div className="md:col-span-2">
            ...
            {step === "review" && (
              <CheckoutReview
                address={address}
                items={items}
                handlePlaceOrder={handlePlacedOrder}
                loading={loading}
                total={total}
              />
            )}
