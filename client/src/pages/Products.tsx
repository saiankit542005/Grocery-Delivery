            ...
            {loading ? (
              ...
              <div className="text-center py-16">
                ...
                <button
                  ...
                  className="px-5 py-2 text-sm font-semibold bg-app-green text-white rounded-xl hover:bg-app-green-light transition-colors"
                >
                  Clear Filters
                </button>
              </div>
                  ...
                  <div className="flex-center gap-2 mt-16">
                    {Array.from({ length: totalPages }).map((_, i) => (
                      <button
                        ...
                        className={`size-9 rounded-lg text-sm font-medium transition-colors ${page === i + 1 ? "bg-app-green text-white" : "bg-white text-app-text-light"}`}
                      >
                        {i + 1}
                      </button>
                    ))}
