      ...
      <div className="bg-linear-to-r from-app-orange to-app-orange-dark text-white py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="flex-center gap-2 mb-3">
            ...
            <h1 className="fext-3xl font-semibold"> Flash Deals</h1>
            <Zap className="size-6 fill-white" />
          </div>
          <p className="text-white/80 max-w-md mx-auto">
            Limited-time offers on your favorite ornagic products.Grab then
            before they're gone!
          </p>
        </div>
      </div>
      ...
      <div>
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <h2 className="text-lg font-semibold text-app-text-light mx-auto mb-4">
              No deals right now
            </h2>
