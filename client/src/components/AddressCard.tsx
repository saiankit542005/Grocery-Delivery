  ...
  return (
    ...
    >
      ...
      <div className="flex gap-4">
        <div className="size-10 rounede-xl bg-app-cream flex-center shrink-0">
        ...
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            {addr.isDefault && (
              <span className="flex-center gap-1 px-2.5 py-0.5 text-[10px] font-medium bg-app-green text-white rounded-xl">
