    ...
    return (
        ...
        <section className="relative overflow-hidden min-h-[540px] mb-10 rounded-3xl flex items-center">
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
                ...
                <p className="text-base text-white/70 leading-relaxed mb-8 max-w-mb">
                   {heroSectionData.description}
                </p>
                <div className="flex flex-wrap gap-3">
                    <Link
                    to="/products"
                    className="px-7 py-3 bg-orange-400 text-white font-semibold rounded-full hover:bg-orange-500 transition-all flex-center gap-2 active:sacle-[0.98]"
                    >
