      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        <form onSubmit={handleSubmit} className="">
          <input
            ...
            required
            className="flex-1 px-5 py-3.5 rounded-xl m-5 border border-app-border focus:border-app-green focus:ring bg-white text-sm transition-all"
          />
          <button
            type="submit"
