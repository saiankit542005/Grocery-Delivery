      ...
      <div className="fixed right-0 top-0 h-full w-full max-w-md bg-white z-50 shadow-2xl flex flex-col animate-slide-in-right">
        ...
        <div className="flex items-center justify-between p-5 border-b border-app-border">
          <div className="flex items-center gap-2">
            ...
            <span className="px-2 py-0.5 font-semibold bg-app-cream rounded-full">
              {items.length} items
            </span>
          </div>
          <button
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-4">
          {items.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full text-center">
              ...
              <h3 className="text-lg font-medium mb-1">You cart is empty</h3>
            </div>
          ) : (
            items.map((item) => (
              <div
        ...
        {items.length > 0 && (
          <div className="p-5 border-t border-app-border space-y-3">
            ...
            <div className="flex justify-between text-base text-semibold border-t border-app-border pt-3">
              <span>Total</span>
              <span>
                {currency}
            ...
            <button
              ...
              className="w-full py-4 bg-app-orange text-white font-semibold rounded-xl hover:bg-app-orange-dark transition-colors flex-center gap-2 active:scale-[0.98]"
            >
