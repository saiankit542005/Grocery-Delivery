...
export default function LiveMap({
  ...
  console.log("LiveMap liveLocation:", liveLocation);
  console.log("Order status:", order.status);
  // console.log("Partner:", liveLocation.lat, liveLocation.lng);
  // console.log(
  //   "Destination:",
        ...
        >
          {liveLocation && liveLocation.lat !== 0 ? (
            ...
            >
              ...
              <Marker
                position={[liveLocation.lat + 0.005, liveLocation.lng + 0.005]}
                icon={truckIcon}
              >
